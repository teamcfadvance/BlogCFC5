		...
		<cfsavecontent variable="toolbarHTML">
			...
			<script type='text/javascript'>
				function toggle_view_#arguments.codesig#() {
					...
					if (temp=='none') {
						document.getElementById('view_#arguments.codesig#').innerHTML='view formatted';
					} else {
				...
				function print_#arguments.codesig#() {
					window.frames['print_frame_#arguments.codesig#'].document.body.innerHTML = document.getElementById('formatted_code_#arguments.codesig#').innerHTML;
					window.frames['print_frame_#arguments.codesig#'].focus();
					window.frames['print_frame_#arguments.codesig#'].print();
				}
				function show_about_#arguments.codesig#() {
					document.getElementById('about_#arguments.codesig#').style.display='inline';
			...
			<span id='about_#arguments.codesig#' style='display:none;#getStyle("TEXT")#'><span style='#getStyle("LINENUMBER")#'>&nbsp;</span>&nbsp;ColdFISH is developed by Jason Delmore.  Source code and license information available at <a href='http://coldfish.riaforge.org/'>coldfish.riaforge.org</a><br/></span>
			<span id='htmlencoded_plain_#arguments.codesig#' style='display:none;#getStyle("TEXT")#'>#REReplace(REReplace(htmleditformat(arguments.code), "\n", "<br />", "ALL"),"\t","&nbsp;&nbsp;&nbsp;&nbsp;","ALL")#</span>
		</cfsavecontent>
