...
<cfif not isNumeric(url.startrow) or url.startrow lte 0 or round(url.startrow) neq url.startrow or not isValid("integer",url.startrow)>
	<cfset url.startrow = 1>
</cfif>
<cfset params.startrow = url.startrow>
<cfset params.maxEntries = application.settings.maxEntries>
