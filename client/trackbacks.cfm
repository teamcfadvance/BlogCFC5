...
<!--- Modification by Ben Forta - 3rd clause tends to help block errors generated by spam bots --->
<cfif not isDefined("url.id") or not application.trackbacksAllowed or not structCount(URL) is 1>
	<cfabort>
</cfif>
